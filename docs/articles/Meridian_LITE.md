---
layout: page
title: Meridian_LITE ボードについて
permalink: /:basename:output_ext
---

<img width="400" alt="lite_pinassign" src="./images/Meridian_LITE_Board.jpg">
...
<img width="800" alt="lite_pinassign" src="./Meridian_Board_LITE_pinassign.png">
ピンアサインは上記の通りです. <br>
...
<img width="400" alt="Mount_KHR37" src="./images/Meridian_LITE_Mount_KHR3.png">
