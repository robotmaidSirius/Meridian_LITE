...
public:
  ...
  void servo_mounts_2lines(ServoParam a_sv) {
    print_servo_ids("UART_L Servos mounted: ", a_sv.ixl.num_max, a_sv.ixl.mount, a_sv.ixl.id);
    print_servo_ids("UART_R Servos mounted: ", a_sv.ixr.num_max, a_sv.ixr.mount, a_sv.ixr.id);
  }
