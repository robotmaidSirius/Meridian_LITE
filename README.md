# [Meridian_LITE v1.2.0](https://github.com/Ninagawa123/Meridian_LITE/)
...
慣れてている方はもちろんgit cloneなどでもかまいません.サブモジュールを追加しているため '--recursive' を追加してください。

```bash
git clone --recursive https://github.com/Ninagawa123/Meridian_LITE.git
```

または

```bash
git clone https://github.com/Ninagawa123/Meridian_LITE.git
